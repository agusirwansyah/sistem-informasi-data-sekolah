<?php
$no=$_GET['no'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_pemasaran WHERE no ='$no'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-warning">
                ...
                <div class="panel-footer">
                    <a href="?page=pemasaran&actions=tampil" class="btn btn-danger btn-sm">
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_pemasaran SET tahun='$tahun',laki_laki='$laki_laki',perempuan='$perempuan',jumlah_siswa='$jumlah_siswa' WHERE no ='$no'"; 
