    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Selamat Datang di Sistem Informasi SMK Negeri 1 Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Struktur SMK Negeri 1 Kisaran</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">NIK/NIP</th><th>Nama</th><th>Tanggal Masuk</th><th>Jabatan</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="level" class="form-control input-sm"
                                   placeholder="Level" required="" autocomplete="off"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
